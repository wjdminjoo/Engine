...
public class MonsteFSMManager : MonoBehaviour, IFSMManager {
    ...
    public MonsterState CurrentSateComponent
    {
    ...
    private MonsterSetting _monsterSet;
    public MonsterSetting MonsterSet { get { return _monsterSet; } }
    ...
    {
        _state[CurrntState].AttackBehavior();
    }
